...
using MAI_SWE_MLML.Model;
using Microsoft.ML.Vision;

namespace MAI_SWE_MLML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\veren\AppData\Local\Temp\86084a6b-fae3-4147-aa4a-b6ff5152d511.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\veren\AppData\Local\Temp\MLVSTools\MAI_SWE_MLML\MAI_SWE_MLML.Model\MLModel.zip";
